...
import { LayoutDashboard, Briefcase, PlusCircle, CalendarClock, Settings, DatabaseZap, BrainCircuit, Building2, ListTree, ShieldCheck, Network } from 'lucide-react';
import './Sidebar.css';
...
const Sidebar = ({ activeView, setActiveView }) => {
    const navItems = [
        ...
        { id: 'job-intelligence', label: 'Job Intelligence', icon: ShieldCheck },
        { id: 'source-catalogs', label: 'Source Catalogs', icon: Network },
