...
from app.services.crawl_task_snapshot_service import (
    build_crawl_task_snapshot as _shared_build_crawl_task_snapshot,
...
def _build_progress_snapshot(
    ...
    *,
    ...
    return _shared_build_crawl_task_snapshot(
        crawl_job,
        latest_event,
        now=now,
        events=events,
...
def _collect_progress_payload() -> dict[str, Any]:
    return collect_progress_payload(repository=repository)
